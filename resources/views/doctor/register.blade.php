...
<head>
    ...
    <title>Doctor Registration - Maternity Management System</title>
...
<body>
    <header class="header" role="banner">
        <div class="container">
            ...
            <p>Register as a doctor to manage maternity care</p>
        </div>
    </header>
    ...
    <div class="form-container" role="main">
        ...
        <form method="POST" action="{{ route('doctor.register') }}" aria-label="Doctor Registration Form">
            @csrf
            <div class="mb-3">
        ...
        <div class="text-center mt-3">
            <a href="{{ route('doctor.login') }}">Already have an account? Login</a>
        </div>
    </div>
