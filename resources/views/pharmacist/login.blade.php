...
<head>
    ...
    <title>Pharmacist Login - Maternity Management System</title>
...
<body>
    <header class="header" role="banner">
        <div class="container">
            ...
            <p>Your partner in healthcare services for pharmacists</p>
        </div>
    </header>

    <div class="form-container" role="main">
        <h3 class="text-center">Pharmacist Login</h3>
        ...
        <form method="POST" action="{{ route('pharmacist.login.submit') }}" aria-label="Pharmacist Login Form">
            @csrf
            <div class="mb-3">
        ...
        <div class="text-center mt-3">
            <a href="{{ route('pharmacist.registration') }}">Don't have an account? Register</a>
        </div>
    </div>
