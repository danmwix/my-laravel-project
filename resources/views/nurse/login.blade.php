...
<head>
    ...
    <title>Nurse Login - Maternity Management System</title>
    <!-- Bootstrap CSS -->
...
<body>
    <header class="header" role="banner">
        <div class="container">
            ...
            <p>Your partner in healthcare services for nurses</p>
        </div>
    </header>

    <div class="form-container" role="main">
        <h3 class="text-center">Nurse Login</h3>
        ...
        <div class="text-center mt-3">
            <a href="{{ route('nurse.registration') }}">Don't have an account? Register</a>
        </div>
    </div>
