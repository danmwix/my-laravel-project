...
<head>
    ...
    <title>Nurse Registration - Maternity Management System</title>
    <!-- Bootstrap CSS -->
...
<body>
    <header class="header" role="banner">
        <div class="container">
            ...
            <p>Register as a nurse to manage maternity care</p>
        </div>
    </header>

    <div class="form-container" role="main">
        <h3 class="text-center">Nurse Registration</h3>
        ...
        <form method="POST" action="{{ route('nurse.register') }}" aria-label="Nurse Registration Form">
            @csrf
            <div class="mb-3">
        ...
        <div class="text-center mt-3">
            <a href="{{ route('nurse.showlogin') }}">Already have an account? Login</a>
        </div>
    </div>
